...
class Test_main(object):
    def correr_tests(self):
        ...
        print("========================================================")
        print("Todas las pruebas MAIN fueron realizadas con exito")
        print("========================================================")
    ...
    def test_definir_jugadores_PVC(self):
        ...
        assert isinstance(recibido[0], Persona) and isinstance(
            recibido[1], Pc
    ...
    def test_definir_jugadores_CVC(self):
        ...
        assert isinstance(recibido[0], Pc) and isinstance(
            recibido[1], Pc
    ...
    def test_primer_turno(self):
        ...
        assert (
            recibido == jugadores or recibido == jugadores[::-1]
